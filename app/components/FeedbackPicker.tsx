    ...
    <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
      <View style={{ justifyContent: "center", alignItems: "center" }}>
        <IconButton
          ...
          icon={() => <Icon icon="emoji-sad" size="large" color={colors.red} />}
        />
        <BodySmallLabel
          style={{
            color: colors.red,
      ...
      <View style={{ justifyContent: "center", alignItems: "center" }}>
        <IconButton
          ...
          icon={() => (
            <Icon icon="emoji-neutral" size="large" color={colors.yellow} />
          )}
        />
        <BodySmallLabel
          style={{
      ...
      <View style={{ justifyContent: "center", alignItems: "center" }}>
        <IconButton
          ...
          icon={() => (
            <Icon icon="emoji-happy" size="large" color={colors.green} />
          )}
        />
        <BodySmallLabel
          style={{
