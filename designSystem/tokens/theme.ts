...
// Generated via https://callstack.github.io/react-native-paper/docs/guides/theming/#creating-dynamic-theme-colors with color #764ABC
export const paperThemeLight: MD3Colors = {
  primary: 'rgb(113, 69, 183)',
...
export const paperThemeDark: MD3Colors = {
  primary: 'rgb(213, 186, 255)',
  onPrimary: 'rgb(65, 6, 134)',
  primaryContainer: 'rgb(89, 42, 158)',
