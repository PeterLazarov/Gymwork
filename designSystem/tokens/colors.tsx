export const colorSchemas = {
  ...
  green: { default: '#4CAF50', light: '#A3D1A3', lighter: '#C8E6CB' },
  ...
  coolMintGreen: { default: '#4DB6AC', light: '#BBE1E9', lighter: '#E6F8F6' },
...
export const colors = {
  ...
  accent: colorSchemas.coolMintGreen.default,
  accentLight: colorSchemas.coolMintGreen.light,
  accentLighter: colorSchemas.coolMintGreen.lighter,
